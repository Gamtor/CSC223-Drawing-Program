...
public class ultimateBlurringVersion13 extends JFrame implements ActionListener,MouseListener{
    int gridx = 50;
    int gridy = 40;
    int gridXOffset=20;
    int gridYOffset=20;
            ...
            for(int green=0; green<12; green++){
                for(int blue=0; blue<12; blue++){
                    for(int red=0; red<12; red++){
                        ...
                        g2.setColor(currentColor);
                        if(colorGridY<12){
                            g2.fillRect(colorGridX*width+xPos+colorOffsetX+1040,(colorGridY*length+yPos)+colorOffsetY-110,width,length);
                        }
                        repeats += 1;
                        colorGridX++;
                        if(colorGridX>=12){
            ...
            for(int red=0; red<12; red++){
                for(int green=0; green<12; green++){
                    for(int blue=0; blue<12; blue++){
                        ...
                        g2.setColor(currentColor);
                        if(colorGridY<12){
                            g2.fillRect(colorGridX*width+xPos+colorOffsetX+875,(colorGridY*length+yPos)+colorOffsetY+55,width,length);
                        }
                        repeats += 1;
                        colorGridX++;
                        if(colorGridX>=12){
            ...
            for(int blue=0; blue<12; blue++){
                for(int red=0; red<12; red++){
                    for(int green=0; green<12; green++){
                        ...
                        g2.setColor(currentColor);
                        if(colorGridY<12){
                            g2.fillRect(colorGridX*width+xPos+colorOffsetX+710,(colorGridY*length+yPos)+colorOffsetY+220,width,length);
                        }
                        repeats += 1;
                        colorGridX++;
                        if(colorGridX>=12){
    ...
    public void mousePressed(MouseEvent e) {
        if(e.getX()/30<=gridx && e.getY()/30<=gridy){
            mousex=Math.round(e.getX()/width)-2; // current mouse X pos
            mousey=Math.round(e.getY()/length)-5; // current mouse Y pos
        }
    ...
    public ultimateBlurringVersion13(){
