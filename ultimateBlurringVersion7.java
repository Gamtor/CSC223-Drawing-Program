...
public class ultimateBlurringVersion7 extends JFrame implements ActionListener,MouseListener{
    int gridx = 40;
    int gridy = 32;
        ...
        for(int red=0; red<12; red++){
            for(int blue=0; blue<12; blue++){
                for(int green=0; green<12; green++){
                    ...
                    g2.setColor(currentColor);
                    if(colorGridY<12){
                        g2.fillRect(colorGridX*width+xPos+1140,(colorGridY*length+yPos)+colorOffset-220,width,length);
                    }
                    repeats += 1;
                    colorGridX++;
                    if(colorGridX>=12){
        ...
        for(int green=0; green<12; green++){
            for(int red=0; red<12; red++){
                for(int blue=0; blue<12; blue++){
                    ...
                    g2.setColor(currentColor);
                    if(colorGridY<12){
                        g2.fillRect(colorGridX*width+xPos+920,(colorGridY*length+yPos)+colorOffset,width,length);
                    }
                    repeats += 1;
                    colorGridX++;
                    if(colorGridX>=12){
        ...
        for(int blue=0; blue<12; blue++){
            for(int green=0; green<12; green++){
                for(int red=0; red<12; red++){
                    ...
                    g2.setColor(currentColor);
                    if(colorGridY<12){
                        g2.fillRect(colorGridX*width+xPos+700,(colorGridY*length+yPos)+colorOffset+220,width,length);
                    }
                    repeats += 1;
                    colorGridX++;
                    if(colorGridX>=12){
    ...
    public ultimateBlurringVersion7(){
