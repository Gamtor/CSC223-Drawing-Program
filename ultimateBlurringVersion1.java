...
public class ultimateBlurringVersion1 extends JFrame implements ActionListener,MouseListener{
    int gridx = 30;
    int gridy = 16;
    ...
    public void mouseClicked(MouseEvent e) {
        int mousex=Math.round(e.getX()); // current mouse X pos
        int mousey=Math.round(e.getY()); // current mouse Y pos
        ...
        setImage[mousex/30][mousey/30] = 255;
        reblur();
        repaint();
    }
    ...
    public ultimateBlurringVersion1(){
