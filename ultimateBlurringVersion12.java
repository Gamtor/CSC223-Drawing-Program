...
/**
 * This version has a fix for the flickering.
 * Now uses JPanel instead for drawing.
 *
 * Tishar
 * Version 12
 */
...
public class ultimateBlurringVersion12 extends JFrame implements ActionListener,MouseListener{
    int gridx = 60;
    int gridy = 48;
    int gridXOffset=20;
    int gridYOffset=60;
    ...
    public void mousePressed(MouseEvent e) {
        if(e.getX()/30<=gridx && e.getY()/30<=gridy){
            ...
            mousey=Math.round(e.getY()/20)-5; // current mouse Y pos
        }
    ...
    public ultimateBlurringVersion12(){
