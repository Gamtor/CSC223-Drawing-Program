...
public class ultimateBlurringVersion9 extends JFrame implements ActionListener,MouseListener{
    int gridx = 60;
    int gridy = 48;
    int gridXOffset=20;
    int gridYOffset=60;
    ...
    public void mouseColor() throws Exception{
        ...
        robot.delay(100);
        double robotMouseX = (MouseInfo.getPointerInfo().getLocation().getX())/(20)-1;
        double robotMouseY = (MouseInfo.getPointerInfo().getLocation().getY())/(20)-3;
        
        robotMouseX = Math.round(robotMouseX);
        robotMouseY = Math.round(robotMouseY);
        mouseColor = robot.getPixelColor((int)robotMouseX, (int)robotMouseY);
        //System.out.println("Color = " + currentColor);  
        System.out.println(mouseColor.getRed()+", "+mouseColor.getGreen()+", "+mouseColor.getBlue());
        System.out.println("MouseX = "+robotMouseX+", MouseY = "+robotMouseY);
        setImageR[gridx][0] = mouseColor.getRed();
        setImageG[gridx][0] = mouseColor.getGreen();
        setImageB[gridx][0] = mouseColor.getBlue();
    }
    ...
    public ultimateBlurringVersion9(){
