...
public class ultimateBlurringVersion15 extends JFrame implements ActionListener,MouseListener{
    int gridx = 50;
    int gridy = 40;
    ...
    void createDialog(String title, String text){ // Method to create a dialog box
        ...
        box.setBounds(400,400,150,80); // dialog box size
    ...
    public void actionPerformed(ActionEvent e){ // runs when an actionlistener is called.
        ...
        switch(cmd){ // When this item is selected, do this.
            ...
            case "Save":
                ...
                createDialog("Drawing code! Share or save for later!",""+saveCode);
                break;
            case "Load":
                
                String loadCode = JOptionPane.showInputDialog(null, "Load Code");
                System.out.println(loadCode);
                // saveCode = loadCode.split(",").toInt();
                break;
            default: break;
        }
    }
    ...
    public ultimateBlurringVersion15(){
