...
public class ultimateBlurringVersion3 extends JFrame implements ActionListener,MouseListener{
    int gridx = 30;
    int gridy = 16;
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        //setImage[mousex][mousey] =  colorSwitch; =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-= Commented out because it's an error. This needs to be fixed to work.
    ...
    public void paint (Graphics g) {
        ...
        for(int y=0; y<gridy+2; y++){
            for(int x=0; x<gridx+2; x++){
                Color currentColor = new Color(colorR,colorG,colorB);
    ...
    public ultimateBlurringVersion3(){
